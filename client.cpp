...
// NOTE TO GROUP:
 // The code we need to write is primarily called from the run() method.
 // Run this client instead of the included sample client.
 // This file was taken from the src folder of rcssserver.
